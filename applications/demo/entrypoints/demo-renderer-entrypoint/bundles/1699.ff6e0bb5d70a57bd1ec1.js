    ...
    73530: (e) => {
      e.exports = function (e) {
        const a = '<\\?(lasso(script)?|=)',
          ...
          t = e.COMMENT('\x3c!--', '--\x3e', { relevance: 0 }),
          s = {
            className: 'meta',
            begin: '\\[noprocess\\]',
            starts: { end: '\\[/noprocess\\]', returnEnd: !0, contains: [t] },
          },
          ...
          l = [
            ...
            },
            {
              begin: /(->|\.)\s*/,
              relevance: 0,
              contains: [{ className: 'symbol', begin: "'[a-zA-Z_][\\w.]*'" }],
            },
            {
              className: 'class',
              ...
              contains: [
                e.inherit(e.TITLE_MODE, { begin: '[a-zA-Z_][\\w.]*(=(?!>))?|[-+*/%](?!>)' }),
              ],
            },
          ]
        return {
          ...
          contains: [
            {
              ...
              begin: n,
              relevance: 0,
              starts: { end: '\\[|' + a, returnEnd: !0, relevance: 0, contains: [t] },
            },
            s,
            i,
            {
                ...
                contains: [
                  {
                    ...
                    begin: n,
                    relevance: 0,
                    starts: { end: '\\[noprocess\\]|' + a, returnEnd: !0, contains: [t] },
                  },
                  s,
                  i,
                ].concat(l),
...
//# sourceMappingURL=1699.ff6e0bb5d70a57bd1ec1.js.map
