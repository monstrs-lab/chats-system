      ...
      'undefined' != typeof self && self,
        (i = function () {
              ...
              function r(e) {
                try {
                  ...
                  if (e && ('object' == typeof e || 'function' == typeof e)) {
                    var t = e.then
                    if ('function' == typeof t) return void u(n(t, e), n(r, this), n(a, this))
                  }
              ...
              ;(i.prototype.catch = function (e) {
                ...
                (i.prototype.then = function (e, t) {
                  ...
                  return new i(function (i, r) {
                    o.call(n, new l(e, t, i, r))
                  })
                }),
                (i.all = function () {
                  var e = Array.prototype.slice.call(
                    1 === arguments.length && p(arguments[0]) ? arguments[0] : arguments
                  )
          ...
          var t,
            ...
            i,
            o = ['Webkit', 'Moz', 'ms'],
            r = 'undefined' != typeof document ? document.createElement('div').style : {},
            a = [1, 8, 3, 6],
            s = [2, 7, 4, 5]
          function l(e) {
            if (e in r) return e
          ...
          ;(w.parse = function (e) {
            ...
            (w.fromString = function (e) {
              var t = e.split(') '),
                n = t[0].substring(re.globals.translate.length + 1).split(','),
            ...
            (w.prototype.toString = function () {
              var e = g[re.globals.translate].suffix || ''
              return (
                re.globals.translate +
                '(' +
                this.x +
                'px, ' +
                this.y +
          ...
          function C() {
            ...
            ;(a.options.useCanvas = a.options.enableOrientation || E.call(a)),
              (a.data = {}),
              (a.elements = {}),
              ...
              p(e, { width: o + (isNaN(o) ? '' : 'px'), height: r + (isNaN(r) ? '' : 'px') }),
              d(n, 'cr-viewport'),
              s && d(n, s),
              p(n, {
              ...
              d(a.elements.preview, 'cr-image'),
              m(a.elements.preview, { alt: 'preview', 'aria-grabbed': 'false' }),
              d(i, 'cr-overlay'),
              a.element.appendChild(e),
              e.appendChild(a.elements.preview),
              e.appendChild(n),
              e.appendChild(i),
              d(a.element, 'croppie-container'),
              a.options.customClass && d(a.element, a.options.customClass),
              M.call(this),
              a.options.enableZoom && R.call(a),
              a.options.enableResize && _.call(a)
          }
          function E() {
          ...
          function _() {
            ...
            function m(i) {
              ...
              var h = a - t,
                d = s - n,
                m = l.options.viewport.height + d,
                f = l.options.viewport.width + h
              'v' === e && m >= 50 && m <= r
                ? (p(u, { height: m + 'px' }),
                  (l.options.boundary.height += d),
                  p(l.elements.boundary, { height: l.options.boundary.height + 'px' }),
                  (l.options.viewport.height += d),
                  p(l.elements.viewport, { height: l.options.viewport.height + 'px' }))
                : 'h' === e &&
                  f >= 50 &&
                  f <= o &&
                  (p(u, { width: f + 'px' }),
                  (l.options.boundary.width += h),
                  p(l.elements.boundary, { width: l.options.boundary.width + 'px' }),
                  (l.options.viewport.width += h),
                  p(l.elements.viewport, { width: l.options.viewport.width + 'px' })),
                z.call(l),
                S.call(l),
                I.call(l),
                H.call(l),
            ...
            d(u, 'cr-resizer'),
              ...
              this.options.resizeControls.height &&
                (d((a = document.createElement('div')), 'cr-resizer-vertical'), u.appendChild(a)),
              this.options.resizeControls.width &&
                (d((s = document.createElement('div')), 'cr-resizer-horisontal'), u.appendChild(s)),
              a && (a.addEventListener('mousedown', h), a.addEventListener('touchstart', h)),
              s && (s.addEventListener('mousedown', h), s.addEventListener('touchstart', h)),
          ...
          function B(e) {
            ...
            if (
              ...
              var l = Z.call(i, r),
                u = l.translate,
                c = l.origin
              o.x >= u.maxX && ((a.x = c.minX), (o.x = u.maxX)),
                o.x <= u.minX && ((a.x = c.maxX), (o.x = u.minX)),
                o.y >= u.maxY && ((a.y = c.minY), (o.y = u.maxY)),
                o.y <= u.minY && ((a.y = c.maxY), (o.y = u.minY))
            }
            s(), Y.call(i), H.call(i)
          }
          function Z(e) {
            ...
            return {
              ...
              origin: { maxX: l * (1 / n) - m, minX: m, maxY: u * (1 / n) - f, minY: f },
            }
          }
          function I(e) {
            var i = this,
              o = i._currentZoom,
              r = i.elements.preview.getBoundingClientRect(),
              a = i.elements.viewport.getBoundingClientRect(),
              s = w.parse(i.elements.preview.style[n]),
              l = new y(i.elements.preview),
              u = a.top - r.top + a.height / 2,
              c = a.left - r.left + a.width / 2,
              h = {},
              d = {}
            if (e) {
              var m = l.x,
              ...
              (h.y = u / o),
                ...
                (s.y -= d.y)
            var b = {}
            ;(b[t] = h.x + 'px ' + h.y + 'px'), (b[n] = s.toString()), p(i.elements.preview, b)
          }
          function M() {
            var e,
              t,
            ...
            function m(i) {
              ...
              if ('touchmove' === i.type && i.touches.length > 1) {
                ...
                var y = w / o
                return L.call(s, y), void h(s.elements.zoomer)
              }
              u(d, m), (f[n] = a.toString()), p(s.elements.preview, f), z.call(s), (t = l), (e = r)
            }
            function f() {
              c((l = !1)),
                window.removeEventListener('mousemove', m),
            ...
            s.elements.overlay.addEventListener('mousedown', d),
              s.elements.viewport.addEventListener('keydown', function (e) {
                ...
                if (!e.shiftKey || (38 !== e.keyCode && 40 !== e.keyCode)) {
                  ...
                  (t =
                    38 === e.keyCode
                      ? parseFloat(s.elements.zoomer.value) + parseFloat(s.elements.zoomer.step)
                      : parseFloat(s.elements.zoomer.value) - parseFloat(s.elements.zoomer.step)),
                    s.setZoom(t)
              }),
            ...
            Y =
              ...
              function () {
                var e = this,
                  t = arguments,
                  n = function () {
                    ;(X = null), W || k.apply(e, t)
                  },
                  i = W && !X
                clearTimeout(X), (X = setTimeout(n, F)), i && k.apply(e, t)
              })
          function H() {
            var e,
              t = this,
          ...
          function A() {
            ...
            O.call(i) &&
              ...
              (o.opacity = 1),
              p(r, o),
              (e = i.elements.preview.getBoundingClientRect()),
              (i._originalImageWidth = e.width),
              (i._originalImageHeight = e.height),
              (i.data.orientation = E.call(i) ? b(i.elements.img) : i.data.orientation),
              i.options.enableZoom ? S.call(i, !0) : (i._currentZoom = 1),
              (a.scale = i._currentZoom),
              (o[n] = a.toString()),
              p(r, o),
              i.data.points.length ? j.call(i, i.data.points) : N.call(i),
              I.call(i),
              z.call(i))
          }
          function S(e) {
            var t,
              ...
              p = v(r.elements.img, r.data.orientation),
              d = r.elements.viewport.getBoundingClientRect()
            r.options.enforceBoundary &&
              ((i = d.width / p.width), (o = d.height / p.height), (a = Math.max(i, o))),
              a >= s && (s = a + 1),
              (l.min = Q(a, 4)),
              (l.max = Q(s, 4)),
              !e && (u < l.min || u > l.max)
                ? L.call(r, u < l.min ? l.min : l.max)
                : e &&
                  ((n = Math.max(c.width / p.width, c.height / p.height)),
          ...
          function j(e) {
            ...
            var i = this,
              o = e[2] - e[0],
              r = i.elements.viewport.getBoundingClientRect(),
          ...
          function N() {
            var e = this,
              ...
              r = i.left - o.left,
              a = i.top - o.top,
              s = r - (t.width - i.width) / 2,
              l = a - (t.height - i.height) / 2,
              u = new w(s, l, e._currentZoom)
            p(e.elements.preview, n, u.toString())
          }
          function P(e) {
            var t = this,
              n = t.elements.canvas,
            ...
            n.getContext('2d').clearRect(0, 0, n.width, n.height),
              (n.width = i.width),
              (n.height = i.height),
              x(n, i, (t.options.enableOrientation && e) || b(i))
          }
          function T(e) {
            var t = this,
              n = e.points,
            ...
            ;(l.width = c),
              (l.height = h),
              e.backgroundColor && ((u.fillStyle = e.backgroundColor), u.fillRect(0, 0, c, h))
            var p = i,
              d = o,
              m = r,
              v = a,
              ...
              b = h
            return (
              i < 0 && ((p = 0), (g = (Math.abs(i) / r) * c)),
              m + p > t._originalImageWidth && (y = ((m = t._originalImageWidth - p) / r) * c),
              o < 0 && ((d = 0), (w = (Math.abs(o) / a) * h)),
              v + d > t._originalImageHeight && (b = ((v = t._originalImageHeight - d) / a) * h),
              u.drawImage(this.elements.preview, p, d, m, v, g, w, y, b),
              s &&
                ((u.fillStyle = '#fff'),
                (u.globalCompositeOperation = 'destination-in'),
                u.beginPath(),
                u.arc(l.width / 2, l.height / 2, l.width / 2, 0, 2 * Math.PI, !0),
                u.closePath(),
                u.fill()),
              l
            )
          ...
          function $(e, t) {
            ...
            if ('string' == typeof e) (n = e), (e = {})
              ...
              if (void 0 === e && i.data.url) return A.call(i), H.call(i), null
            ...
            return (
              ...
              (function (e, t) {
                ...
                if ((U.call(i, n), o.length))
                  ...
                  s.width / s.height > u
                    ? (r = (a = s.height) * u)
                    : ((r = s.width), (a = s.height / u))
                  var c = (s.width - r) / 2,
                    h = (s.height - a) / 2,
                    p = c + r,
                    d = h + a
                  i.data.points = [c, h, p, d]
                }
                ;(i.data.orientation = e.orientation || 1),
                  (i.data.points = o.map(function (e) {
                    return parseFloat(e)
                  })),
                  i.options.useCanvas && P.call(i, i.data.orientation),
                  A.call(i),
                  H.call(i),
                  t && t()
              })
          ...
          function G() {
            ...
            return (
              ...
              (s = Math.max(c, s / u)),
              (l = Math.max(c, l / u)),
              { points: [Q(i), Q(o), Q(s), Q(l)], zoom: u, orientation: e.data.orientation }
            )
          }
          var V = { type: 'canvas', format: 'png', quality: 1 },
            J = ['jpeg', 'webp', 'png']
          function ee(e) {
            var t = this,
              n = G.call(t),
              ...
              s = i.quality,
              l = i.backgroundColor,
              h = 'boolean' == typeof i.circle ? i.circle : 'circle' === t.options.viewport.type,
              p = t.elements.viewport.getBoundingClientRect(),
              d = p.width / p.height
            return (
              'viewport' === r
                ? ((n.outputWidth = p.width), (n.outputHeight = p.height))
                : 'object' == typeof r &&
                  (r.width && r.height
                    ? ((n.outputWidth = r.width), (n.outputHeight = r.height))
                    : r.width
                    ? ((n.outputWidth = r.width), (n.outputHeight = r.width / d))
                    : r.height && ((n.outputWidth = r.height * d), (n.outputHeight = r.height))),
          ...
          function ne(e) {
            ...
            if (
              ...
              x(u, l.elements.img, l.data.orientation),
              I.call(l, !0),
              S.call(l),
              (Math.abs(e) / 90) % 2 == 1)
            ) {
              var c = l._originalImageHeight,
                h = l._originalImageWidth
              ;(l._originalImageWidth = c), (l._originalImageHeight = h)
            }
          }
          function ie() {
            var e,
              ...
              if ('string' == typeof e) {
                ...
                return 'get' === e
                  ...
                  : this.each(function () {
                      ...
                      if (n) {
                        var i = n[e]
                        if (!oe.isFunction(i)) throw 'Croppie ' + e + ' method not found'
                        i.apply(n, t), 'destroy' === e && oe(this).removeData('croppie')
                      }
                    })
              }
          ...
          function re(e, t) {
            ...
            if (
              ((this.element = e),
              (this.options = u(c(re.defaults), t)),
          ...
          return (
            ...
            (re.globals = { translate: 'translate3d' }),
            u(re.prototype, {
              bind: function (e, t) {
              ...
              setZoom: function (e) {
                L.call(this, e), h(this.elements.zoomer)
              },
              rotate: function (e) {
                ne.call(this, e)
              },
...
//# sourceMappingURL=5099.df15607a8c5332bb3e60.js.map
