  ...
  [3966],
  {
            ...
            if (((t = e[a]), g))
              switch (
                ...
                case 'd':
                  ...
                  break
                case 'f':
                  ;(i = String(parseFloat(d()).toFixed(r || 6))), (l += u ? i : i.replace(/^0/, ''))
                  break
                case 'j':
                  l += JSON.stringify(d())
                  break
    ...
    33390: (e) => {
      ...
      const y = '[a-zA-Z]\\w*',
        ...
        M = function (e, t, n = {}) {
          const i = o({ scope: 'comment', begin: e, end: t, contains: [] }, n)
          i.contains.push({
            scope: 'doctag',
        ...
        A = M('/\\*', '\\*/'),
        I = M('#', '$'),
        j = { scope: 'number', begin: _, relevance: 0 },
        L = { scope: 'number', begin: k, relevance: 0 },
        T = { scope: 'number', begin: v, relevance: 0 },
        B = {
          begin: /(?=\/[^/\n]*\/)/,
          contains: [
            {
        ...
        C = { scope: 'title', begin: y, relevance: 0 },
        P = { scope: 'title', begin: E, relevance: 0 }
      var H = Object.freeze({
        __proto__: null,
      ...
      function ee(e, t, { key: n }) {
        ...
        const r = e[n],
          o = {},
          s = {}
        for (let e = 1; e <= t.length; e++) (s[e + i] = r[e]), (o[e + i] = !0), (i += m(t[e - 1]))
          ...
          (function (e) {
            if (Array.isArray(e.begin)) {
              if (e.skip || e.excludeBegin || e.returnBegin)
                throw (V('skip, excludeBegin, returnBegin not compatible with beginScope: {}'), Q)
              if ('object' != typeof e.beginScope || null === e.beginScope)
                throw (V('beginScope must be object'), Q)
              ee(e, e.begin, { key: 'beginScope' }), (e.begin = w(e.begin, { joinWith: '' }))
            }
          })(e),
          (function (e) {
            if (Array.isArray(e.end)) {
              if (e.skip || e.excludeEnd || e.returnEnd)
                throw (V('skip, excludeEnd, returnEnd not compatible with endScope: {}'), Q)
              if ('object' != typeof e.endScope || null === e.endScope)
                throw (V('endScope must be object'), Q)
              ee(e, e.end, { key: 'endScope' }), (e.end = w(e.end, { joinWith: '' }))
            }
          })(e)
      }
      function ne(e) {
          ...
          (function n(r, s) {
            ...
            return (
              ...
              s &&
                ...
                r.endsWithParent &&
                  s.terminatorEnd &&
                  (a.terminatorEnd += (r.end ? '|' : '') + s.terminatorEnd)),
      ...
      var ce = (function (e) {
        ...
        function m(e, t, n) {
          ...
          'object' == typeof t
            ...
            : (Y('10.7.0', 'highlight(lang, code, ...args) has been deprecated.'),
              Y(
                '10.7.0',
          ...
          const s = o.result ? o.result : x(o.language, o.code, n)
          return (s.code = o.code), S('after:highlight', s), s
        }
        function x(e, t, r, o) {
          const c = Object.create(null)
          function g() {
            if (!N.keywords) return void O.addText(M)
            let e = 0
            N.keywordPatternRe.lastIndex = 0
            let t = N.keywordPatternRe.exec(M),
              n = ''
            for (; t; ) {
              ...
              ;(e = N.keywordPatternRe.lastIndex), (t = N.keywordPatternRe.exec(M))
            }
            var i
            ;(n += M.substring(e)), O.addText(n)
          }
          function u() {
            null != N.subLanguage
              ? (function () {
                  ...
                  if ('string' == typeof N.subLanguage) {
                    if (!n[N.subLanguage]) return void O.addText(M)
                    ;(e = x(N.subLanguage, M, !0, S[N.subLanguage])), (S[N.subLanguage] = e._top)
                  } else e = w(M, N.subLanguage.length ? N.subLanguage : null)
                  N.relevance > 0 && (R += e.relevance), O.addSublanguage(e._emitter, e.language)
                })()
              : g(),
              (M = '')
          }
          ...
          function h(e, t) {
            return (
              e.scope &&
                ...
                O.openNode(E.classNameAliases[e.scope] || e.scope),
              e.beginScope &&
                (e.beginScope._wrap
                  ? (O.addKeyword(M, E.classNameAliases[e.beginScope._wrap] || e.beginScope._wrap),
                    (M = ''))
                  : e.beginScope._multi && (d(e.beginScope, t), (M = ''))),
          ...
          function p(e) {
            return 0 === N.matcher.regexIndex ? ((M += e[0]), 1) : ((j = !0), 0)
          }
          function b(e) {
            const n = e[0],
            ...
            N.endScope && N.endScope._wrap
              ? (u(), O.addKeyword(n, N.endScope._wrap))
              : N.endScope && N.endScope._multi
              ? (u(), d(N.endScope, e))
              : o.skip
              ? (M += n)
              : (o.returnEnd || o.excludeEnd || (M += n), u(), o.excludeEnd && (M = n))
            do {
              N.scope && O.closeNode(),
                N.skip || N.subLanguage || (R += N.relevance),
                (N = N.parent)
            } while (N !== r.parent)
            return r.starts && h(r.starts, e), o.returnEnd ? 0 : n.length
          }
          let m = {}
          function y(n, o) {
            const a = o && o[0]
            if (((M += n), null == a)) return u(), 0
            if ('begin' === m.type && 'end' === o.type && m.index === o.index && '' === a) {
              if (((M += t.slice(o.index, o.index + 1)), !s)) {
            ...
            if (((m = o), 'begin' === o.type))
              return (function (e) {
                ...
                for (const n of o) if (n && (n(e, r), r.isMatchIgnored)) return p(t)
                return (
                  n.skip
                    ? (M += t)
                    : (n.excludeBegin && (M += t), u(), n.returnBegin || n.excludeBegin || (M = t)),
                  h(n, e),
          ...
          const E = k(e)
          if (!E) throw (V(a.replace('{}', e)), new Error('Unknown language: "' + e + '"'))
          const _ = ne(E)
          let v = '',
            N = o || _
          const S = {},
          ...
          !(function () {
            const e = []
            for (let t = N; t !== E; t = t.parent) t.scope && e.unshift(t.scope)
          ...
          try {
            for (N.matcher.considerAll(); ; ) {
              I++, j ? (j = !1) : N.matcher.considerAll(), (N.matcher.lastIndex = A)
              const e = N.matcher.exec(t)
              if (!e) break
              const n = y(t.substring(A, e.index), e)
              A = e.index + n
            }
            return (
              y(t.substring(A)),
              ...
              O.finalize(),
              (v = O.toHTML()),
              { language: e, value: v, relevance: R, illegal: !1, _emitter: O, _top: N }
            )
          } catch (n) {
        ...
        function y(e) {
          ...
          const n = (function (e) {
            ...
            return t.split(/\s+/).find((e) => u(e) || k(e))
          })(e)
          if (u(n)) return
          if (
          ...
          const i = t.textContent,
            o = n ? m(i, { language: n, ignoreIllegals: !0 }) : w(i)
          ;(e.innerHTML = o.value),
            (function (e, t, n) {
              const i = (t && r[t]) || n
        ...
        function _() {
          'loading' !== document.readyState
            ? document.querySelectorAll(l.cssSelector).forEach(y)
            : (E = !0)
        }
        function k(e) {
        ...
        'undefined' != typeof window &&
          ...
          Object.assign(e, {
            ...
            initHighlighting: () => {
              _(), Y('10.6.0', 'initHighlighting() deprecated.  Use highlightAll() now.')
            },
            initHighlightingOnLoad: function () {
              _(), Y('10.6.0', 'initHighlightingOnLoad() deprecated.  Use highlightAll() now.')
            },
            registerLanguage: function (t, i) {
              ...
              try {
                ...
                if (
                  (V("Language definition for '{}' could not be registered.".replace('{}', t)), !s)
                )
                  throw e
                V(e), (r = c)
              }
              r.name || (r.name = t),
                ...
                r.aliases && v(r.aliases, { languageName: t })
            },
          ...
          (e.regex = { concat: p, lookahead: d, either: b, optional: f, anyNumberOfTimes: h })
        for (const e in H) 'object' == typeof H[e] && t.exports(H[e])
    ...
    93966: (e, t, n) => {
      ...
      const i = n(33390)
      var r = n(46291)
      const o = Object.assign(s(Error), {
        eval: s(EvalError),
        range: s(RangeError),
        reference: s(ReferenceError),
        syntax: s(SyntaxError),
        type: s(TypeError),
        uri: s(URIError),
      })
      function s(e) {
      ...
      function l(e, t, n = {}) {
        ...
        if (!i.getLanguage(e)) throw o('Unknown language: `%s` is not registered', e)
        if ('string' != typeof t) throw o('Expected `string` for value, got `%s`', t)
        null == r && (r = c), i.configure({ __emitter: g, classPrefix: r })
        const s = i.highlight(t, { language: e, ignoreIllegals: !0 })
        if ((i.configure({}), s.errorRaised)) throw s.errorRaised
        return (
          (s._emitter.root.data.language = s.language),
          (s._emitter.root.data.relevance = s.relevance),
          s._emitter.root
        )
      }
      class g {
        ...
        openNode(e) {
          const t = {
            ...
            properties: {
              className: e
                .split('.')
                .map((e, t) => (t ? e + '_'.repeat(t) : this.options.classPrefix + e)),
            },
            children: [],
          }
      ...
      const u = {
        ...
        highlightAuto: function (e, t = {}) {
          const n = t.subset || i.listLanguages()
          let r = t.prefix,
            s = -1,
            a = { type: 'root', data: { language: null, relevance: 0 }, children: [] }
          if ((null == r && (r = c), 'string' != typeof e))
            throw o('Expected `string` for value, got `%s`', e)
          for (; ++s < n.length; ) {
            const r = n[s]
            if (!i.getLanguage(r)) continue
            const o = l(r, e, t)
        ...
        registerLanguage: function (e, t) {
          i.registerLanguage(e, t)
        },
        registered: function (e) {
          return Boolean(i.getLanguage(e))
        },
        listLanguages: function () {
          return i.listLanguages()
        },
        registerAlias: function (e, t) {
          if ('string' == typeof e) i.registerAliases(t, { languageName: e })
          else {
            let t
            for (t in e) a.call(e, t) && i.registerAliases(e[t], { languageName: t })
          }
        },
      }
    },
...
//# sourceMappingURL=3966.659e59dc9abb489b2874.js.map
