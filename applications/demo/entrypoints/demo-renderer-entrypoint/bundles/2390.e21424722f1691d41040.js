    ...
    44210: (e) => {
      ...
      e.exports = function (e) {
        const l = ((e) => ({
          ...
          p = { $pattern: /[a-z-]+/, keyword: 'and or not only', attribute: r.join(' ') },
          u = { begin: '\\(', end: '\\)', contains: b, keywords: p, relevance: 0 }
        b.push(
        ...
        const h = b.concat({ begin: /\{/, end: /\}/, contains: c }),
          f = {
            beginKeywords: 'when',
            endsWithParent: !0,
          ...
          w = {
            ...
            starts: { end: '[;{}]', keywords: p, returnEnd: !0, contains: b, relevance: 0 },
          },
          v = {
            className: 'variable',
          ...
          x = { begin: `[\\w-]+:(:)?(${s.join('|')})`, returnBegin: !0, contains: [y] }
        return (
          c.push(
            e.C_LINE_COMMENT_MODE,
            e.C_BLOCK_COMMENT_MODE,
...
//# sourceMappingURL=2390.e21424722f1691d41040.js.map
