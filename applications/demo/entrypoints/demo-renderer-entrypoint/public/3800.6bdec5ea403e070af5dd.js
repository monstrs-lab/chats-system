    ...
    62543: (e) => {
      e.exports = function (e) {
        const n = e.regex,
          ...
          r = (e) => ({ scope: 'char.escape', begin: n.concat(/\\/, e), relevance: 0 }),
          d = {
            className: 'string',
            begin: '~[a-z](?=[/|([{<"\'])',
            contains: t.map((n) => e.inherit(n, { contains: [r(n.end), c, s] })),
          },
          o = {
            className: 'string',
            begin: '~[A-Z](?=[/|([{<"\'])',
            contains: t.map((n) => e.inherit(n, { contains: [r(n.end)] })),
          },
          b = {
            className: 'regex',
            variants: [
              ...
              },
              {
                begin: '~R(?=[/|([{<"\'])',
                contains: t.map((a) =>
                  e.inherit(a, { end: n.concat(a.end, /[uismxfU]{0,7}/), contains: [r(a.end)] })
                ),
              },
            ],
          },
        ...
        return (
          (s.contains = u), { name: 'Elixir', aliases: ['ex', 'exs'], keywords: i, contains: u }
        )
      }
    },
  },
])
//# sourceMappingURL=3800.6bdec5ea403e070af5dd.js.map
