...
const e = createDecipheriv('AES-256-CTR', clientKey, clientIv)
const d = createDecipheriv('AES-256-CTR', serverKey, serverIv)

console.log(e.update(header).readUInt32BE(56) === 0xefefefef)
//console.log(Buffer.from(d.update(header)).readUInt32BE(56))

//const br = new BinaryReader(Buffer.from(d.update(common)))
