...
import type { TLAuthsessionGetClient }            from '@chats-system/auth-rpc'
import type { TLAuthsessionGetLangCode }          from '@chats-system/auth-rpc'
import type { TLAuthsessionGetUserId }            from '@chats-system/auth-rpc'
import type { TLAuthsessionGetPushSessionId }     from '@chats-system/auth-rpc'
import type { TLAuthsessionGetFutureSalts }       from '@chats-system/auth-rpc'
import type { TLAuthsessionQueryAuthKey }         from '@chats-system/auth-rpc'
import type { TLAuthsessionSetAuthKey }           from '@chats-system/auth-rpc'
import type { TLAuthsessionBindAuthKeyUser }      from '@chats-system/auth-rpc'
import type { TLAuthsessionUnbindAuthKeyUser }    from '@chats-system/auth-rpc'
import type { TLAuthsessionGetPermAuthKeyId }     from '@chats-system/auth-rpc'
import type { TLAuthsessionBindTempAuthKey }      from '@chats-system/auth-rpc'
import type { TLAuthsessionSetClientSessionInfo } from '@chats-system/auth-rpc'
import type { TLAuthsessionGetAuthorization }     from '@chats-system/auth-rpc'
import type { TLAuthsessionGetAuthStateData }     from '@chats-system/auth-rpc'
import type { TLAuthsessionSetLayer }             from '@chats-system/auth-rpc'
import type { TLAuthsessionSetInitConnection }    from '@chats-system/auth-rpc'
import type { AuthKeyStateData }                  from '@chats-system/auth-rpc'
import type { VectorLong }                        from '@chats-system/auth-rpc'
