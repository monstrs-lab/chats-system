...
export abstract class AutoSaveSettings {
   ...
   */
  abstract readonly videoMaxSize: Int64Value[]
}
...
export abstract class BotData {
   ...
   */
  abstract readonly botInlinePlaceholder: StringValue[]
}
...
export abstract class BotInfo {
   ...
   */
  abstract readonly userIdFLAGINT64: Int64Value[]

  /**
   * @generated from field: repeated google.protobuf.StringValue description_FLAGSTRING = 4;
   */
  abstract readonly descriptionFLAGSTRING: StringValue[]
...
export abstract class BotInlineMessage {
   ...
   */
  abstract readonly heading: Int32Value[]
   ...
   */
  abstract readonly proximityNotificationRadius: Int32Value[]
...
export abstract class ChannelParticipant {
   ...
   */
  abstract readonly rank: StringValue[]
   ...
   */
  abstract readonly inviterIdFLAGINT64: Int64Value[]
...
export abstract class ChannelParticipantsFilter {
   ...
   */
  abstract readonly qFLAGSTRING: StringValue[]
...
export abstract class Chat {
   ...
   */
  abstract readonly accessHashFLAGINT64: Int64Value[]
   ...
   */
  abstract readonly participantsCountFLAGINT32: Int32Value[]
   ...
   */
  abstract readonly storiesMaxId: Int32Value[]
   ...
   */
  abstract readonly untilDate: Int32Value[]
}
...
export abstract class ChatFull {
   ...
   */
  abstract readonly pinnedMsgId: Int32Value[]
   ...
   */
  abstract readonly themeEmoticon: StringValue[]

  /**
   * @generated from field: repeated google.protobuf.Int32Value requests_pending = 19;
   */
  abstract readonly requestsPending: Int32Value[]
   ...
   */
  abstract readonly migratedFromChatId: Int64Value[]

  /**
   * @generated from field: repeated google.protobuf.Int32Value migrated_from_max_id = 41;
   */
  abstract readonly migratedFromMaxId: Int32Value[]
   ...
   */
  abstract readonly availableMinId: Int32Value[]

  /**
   * @generated from field: repeated google.protobuf.Int64Value linked_chat_id = 44;
   */
  abstract readonly linkedChatId: Int64Value[]
...
export abstract class ChatInviteImporter {
   ...
   */
  abstract readonly approvedBy: Int64Value[]
}
...
export abstract class CodeSettings {
   ...
   */
  abstract readonly token: StringValue[]
...
export abstract class Config {
   ...
   */
  abstract readonly tmpSessions: Int32Value[]
   ...
   */
  abstract readonly autologinToken: StringValue[]
...
export abstract class ContactData {
   ...
   */
  abstract readonly phone: StringValue[]
}
...
export abstract class Dialog {
   ...
   */
  abstract readonly pts: Int32Value[]
...
export abstract class DialogFilter {
   ...
   */
  abstract readonly emoticon: StringValue[]
...
export abstract class DocumentAttribute {
   ...
   */
  abstract readonly preloadPrefixSize: Int32Value[]
   ...
   */
  abstract readonly performer: StringValue[]
...
export abstract class DraftMessage {
   ...
   */
  abstract readonly dateFLAGINT32: Int32Value[]
...
export abstract class ExportedChatInvite {
   ...
   */
  abstract readonly startDate: Int32Value[]
   ...
   */
  abstract readonly usage: Int32Value[]

  /**
   * @generated from field: repeated google.protobuf.Int32Value requested = 13;
   */
  abstract readonly requested: Int32Value[]
...
export abstract class GeoPoint {
   ...
   */
  abstract readonly accuracyRadius: Int32Value[]
}
...
export abstract class GroupCall {
   ...
   */
  abstract readonly streamDcId: Int32Value[]

  /**
   * @generated from field: repeated google.protobuf.Int32Value record_start_date = 17;
   */
  abstract readonly recordStartDate: Int32Value[]
   ...
   */
  abstract readonly unmutedVideoCount: Int32Value[]
...
export abstract class GroupCallParticipant {
   ...
   */
  abstract readonly activeDate: Int32Value[]
   ...
   */
  abstract readonly raiseHandRating: Int64Value[]
...
export abstract class GroupCallParticipantVideo {
   ...
   */
  abstract readonly audioSource: Int32Value[]
}
...
export abstract class InputFileLocation {
   ...
   */
  abstract readonly videoChannel: Int32Value[]

  /**
   * @generated from field: repeated google.protobuf.Int32Value video_quality = 19;
   */
  abstract readonly videoQuality: Int32Value[]
}
...
export abstract class InputMedia {
   ...
   */
  abstract readonly ttlSeconds: Int32Value[]
   ...
   */
  abstract readonly query: StringValue[]
   ...
   */
  abstract readonly solution: StringValue[]
...
export abstract class InputPeerNotifySettings {
   ...
   */
  abstract readonly muteUntil: Int32Value[]
   ...
   */
  abstract readonly soundFLAGSTRING: StringValue[]
}
...
export abstract class InputThemeSettings {
   ...
   */
  abstract readonly outboxAccentColor: Int32Value[]
...
export abstract class Invoice {
   ...
   */
  abstract readonly maxTipAmount: Int64Value[]
   ...
   */
  abstract readonly termsUrl: StringValue[]

  /**
   * @generated from field: repeated google.protobuf.StringValue recurring_terms_url = 17;
   */
  abstract readonly recurringTermsUrl: StringValue[]
}
...
export abstract class KeyboardButton {
   ...
   */
  abstract readonly fwdText: StringValue[]
...
export abstract class LangPackLanguage {
   ...
   */
  abstract readonly baseLangCode: StringValue[]
...
export abstract class Message {
   ...
   */
  abstract readonly viaBotId: Int64Value[]
   ...
   */
  abstract readonly views: Int32Value[]

  /**
   * @generated from field: repeated google.protobuf.Int32Value forwards = 25;
   */
  abstract readonly forwards: Int32Value[]
...
export abstract class MessageAction {
   ...
   */
  abstract readonly invoiceSlug: StringValue[]
   ...
   */
  abstract readonly duration: Int32Value[]
   ...
   */
  abstract readonly domainFLAGSTRING: StringValue[]
   ...
   */
  abstract readonly autoSettingFrom: Int64Value[]
   ...
   */
  abstract readonly cryptoCurrency: StringValue[]

  /**
   * @generated from field: repeated google.protobuf.Int64Value crypto_amount = 46;
   */
  abstract readonly cryptoAmount: Int64Value[]
   ...
   */
  abstract readonly titleFLAGSTRING: StringValue[]
...
export abstract class MessageExtendedMedia {
   ...
   */
  abstract readonly w: Int32Value[]

  /**
   * @generated from field: repeated google.protobuf.Int32Value h = 4;
   */
  abstract readonly h: Int32Value[]
   ...
   */
  abstract readonly videoDuration: Int32Value[]
...
export abstract class MessageFwdHeader {
   ...
   */
  abstract readonly fromName: StringValue[]
   ...
   */
  abstract readonly channelPost: Int32Value[]
   ...
   */
  abstract readonly savedFromMsgId: Int32Value[]

  /**
   * @generated from field: repeated google.protobuf.StringValue psa_type = 11;
   */
  abstract readonly psaType: StringValue[]
}
...
export abstract class MessageMedia {
   ...
   */
  abstract readonly receiptMsgId: Int32Value[]
...
export abstract class MessageReplyHeader {
   ...
   */
  abstract readonly replyToTopId: Int32Value[]
...
export abstract class PageBlock {
   ...
   */
  abstract readonly webpageIdFLAGINT64: Int64Value[]
...
export abstract class PageTableCell {
   ...
   */
  abstract readonly colspan: Int32Value[]

  /**
   * @generated from field: repeated google.protobuf.Int32Value rowspan = 10;
   */
  abstract readonly rowspan: Int32Value[]
}
...
export abstract class PaymentRequestedInfo {
   ...
   */
  abstract readonly email: StringValue[]
...
export abstract class PeerNotifySettings {
   ...
   */
  abstract readonly sound: StringValue[]
}
...
export abstract class PeerStories {
   ...
   */
  abstract readonly maxReadId: Int32Value[]
...
export abstract class PhoneCall {
   ...
   */
  abstract readonly receiveDate: Int32Value[]
...
export abstract class Poll {
   ...
   */
  abstract readonly closePeriod: Int32Value[]

  /**
   * @generated from field: repeated google.protobuf.Int32Value close_date = 11;
   */
  abstract readonly closeDate: Int32Value[]
}
...
export abstract class PollResults {
   ...
   */
  abstract readonly totalVoters: Int32Value[]
...
export abstract class PredefinedUser {
   ...
   */
  abstract readonly registeredUserId: Int64Value[]

  /**
   * @generated from field: repeated google.protobuf.Int32Value last_seen_at = 10;
   */
  abstract readonly lastSeenAt: Int32Value[]
...
export abstract class PremiumGiftOption {
   ...
   */
  abstract readonly storeProduct: StringValue[]
}
...
export abstract class PremiumSubscriptionOption {
   ...
   */
  abstract readonly transaction: StringValue[]
...
export abstract class ReactionCount {
   ...
   */
  abstract readonly chosenOrder: Int32Value[]
...
export abstract class ReplyMarkup {
   ...
   */
  abstract readonly placeholder: StringValue[]
...
export abstract class SponsoredMessage {
   ...
   */
  abstract readonly chatInviteHash: StringValue[]
   ...
   */
  abstract readonly sponsorInfo: StringValue[]

  /**
   * @generated from field: repeated google.protobuf.StringValue additional_info = 15;
   */
  abstract readonly additionalInfo: StringValue[]
}
...
export abstract class StatsGraph {
   ...
   */
  abstract readonly zoomToken: StringValue[]
}
...
export abstract class StickerSet {
   ...
   */
  abstract readonly installedDate: Int32Value[]
   ...
   */
  abstract readonly thumbDcId: Int32Value[]

  /**
   * @generated from field: repeated google.protobuf.Int32Value thumb_version = 16;
   */
  abstract readonly thumbVersion: Int32Value[]
...
export abstract class StoriesStealthMode {
   ...
   */
  abstract readonly activeUntilDate: Int32Value[]

  /**
   * @generated from field: repeated google.protobuf.Int32Value cooldown_until_date = 4;
   */
  abstract readonly cooldownUntilDate: Int32Value[]
}
...
export abstract class StoryViews {
   ...
   */
  abstract readonly forwardsCount: Int32Value[]
   ...
   */
  abstract readonly reactionsCountFLAGINT32: Int32Value[]
...
export abstract class Theme {
   ...
   */
  abstract readonly installsCount: Int32Value[]
}
...
export abstract class Update {
   ...
   */
  abstract readonly device: StringValue[]

  /**
   * @generated from field: repeated google.protobuf.StringValue location = 22;
   */
  abstract readonly location: StringValue[]
   ...
   */
  abstract readonly inboxDate: Int32Value[]
   ...
   */
  abstract readonly ptsFLAGINT32: Int32Value[]
   ...
   */
  abstract readonly gameShortName: StringValue[]

  /**
   * @generated from field: repeated google.protobuf.Int32Value top_msg_id_FLAGINT32 = 67;
   */
  abstract readonly topMsgIdFLAGINT32: Int32Value[]
   ...
   */
  abstract readonly broadcastId: Int64Value[]

  /**
   * @generated from field: repeated google.protobuf.Int32Value broadcast_post = 101;
   */
  abstract readonly broadcastPost: Int32Value[]
   ...
   */
  abstract readonly topicIdFLAGINT32: Int32Value[]
...
export abstract class User {
   ...
   */
  abstract readonly accessHash: Int64Value[]
   ...
   */
  abstract readonly botInfoVersion: Int32Value[]
   ...
   */
  abstract readonly langCode: StringValue[]
...
export abstract class UserFull {
   ...
   */
  abstract readonly privateForwardName: StringValue[]
...
export abstract class WebPage {
   ...
   */
  abstract readonly type: StringValue[]

  /**
   * @generated from field: repeated google.protobuf.StringValue site_name = 9;
   */
  abstract readonly siteName: StringValue[]
   ...
   */
  abstract readonly cachedPageViews: Int32Value[]
}
...
export abstract class AccountAuthorizationForm {
   ...
   */
  abstract readonly privacyPolicyUrl: StringValue[]
}
...
export abstract class AccountPassword {
   ...
   */
  abstract readonly pendingResetDate: Int32Value[]

  /**
   * @generated from field: repeated google.protobuf.StringValue login_email_pattern = 15;
   */
  abstract readonly loginEmailPattern: StringValue[]
}
...
export abstract class AuthAuthorization {
   ...
   */
  abstract readonly otherwiseReloginDays: Int32Value[]
...
export abstract class AuthSentCode {
   ...
   */
  abstract readonly timeout: Int32Value[]
...
export abstract class AuthSentCodeType {
   ...
   */
  abstract readonly resetAvailablePeriod: Int32Value[]

  /**
   * @generated from field: repeated google.protobuf.Int32Value reset_pending_date = 10;
   */
  abstract readonly resetPendingDate: Int32Value[]
...
export abstract class HelpPromoData {
   ...
   */
  abstract readonly psaMessage: StringValue[]
}
...
export abstract class HelpTermsOfService {
   ...
   */
  abstract readonly minAgeConfirm: Int32Value[]
}
...
export abstract class MessagesDiscussionMessage {
   ...
   */
  abstract readonly readInboxMaxId: Int32Value[]

  /**
   * @generated from field: repeated google.protobuf.Int32Value read_outbox_max_id = 6;
   */
  abstract readonly readOutboxMaxId: Int32Value[]
...
export abstract class MessagesMessages {
   ...
   */
  abstract readonly nextRate: Int32Value[]

  /**
   * @generated from field: repeated google.protobuf.Int32Value offset_id_offset = 9;
   */
  abstract readonly offsetIdOffset: Int32Value[]
...
export abstract class MessagesSponsoredMessages {
   ...
   */
  abstract readonly postsBetween: Int32Value[]
...
export abstract class PaymentsPaymentForm {
   ...
   */
  abstract readonly nativeProvider: StringValue[]
...
export abstract class PaymentsValidatedRequestedInfo {
   ...
   */
  abstract readonly id: StringValue[]
...
export abstract class StoriesBoostsStatus {
   ...
   */
  abstract readonly nextLevelBoosts: Int32Value[]
