...
export class TakeoutMessageRange extends Message<TakeoutMessageRange> {
  ...
  static equals(
    a: TakeoutMessageRange | PlainMessage<TakeoutMessageRange> | undefined,
    b: TakeoutMessageRange | PlainMessage<TakeoutMessageRange> | undefined
  ): boolean {
...
export class Takeout extends Message<Takeout> {
  ...
  static equals(
    a: Takeout | PlainMessage<Takeout> | undefined,
    b: Takeout | PlainMessage<Takeout> | undefined
  ): boolean {
