...
export class DcOption extends Message<DcOption> {
  ...
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    ...
    { no: 5, name: 'media_only', kind: 'scalar', T: 8 /* ScalarType.BOOL */, opt: true },
    { no: 6, name: 'tcpo_only', kind: 'scalar', T: 8 /* ScalarType.BOOL */, opt: true },
    { no: 7, name: 'cdn', kind: 'scalar', T: 8 /* ScalarType.BOOL */, opt: true },
    { no: 8, name: 'static', kind: 'scalar', T: 8 /* ScalarType.BOOL */, opt: true },
    { no: 9, name: 'this_port_only', kind: 'scalar', T: 8 /* ScalarType.BOOL */, opt: true },
