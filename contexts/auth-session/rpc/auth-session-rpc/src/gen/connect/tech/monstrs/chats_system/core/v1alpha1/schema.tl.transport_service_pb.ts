...
export class TLRpcDropAnswer extends Message<TLRpcDropAnswer> {
  ...
  static equals(
    a: TLRpcDropAnswer | PlainMessage<TLRpcDropAnswer> | undefined,
    b: TLRpcDropAnswer | PlainMessage<TLRpcDropAnswer> | undefined
  ): boolean {
...
export class TLGetFutureSalts extends Message<TLGetFutureSalts> {
  ...
  static equals(
    a: TLGetFutureSalts | PlainMessage<TLGetFutureSalts> | undefined,
    b: TLGetFutureSalts | PlainMessage<TLGetFutureSalts> | undefined
  ): boolean {
...
export class TLPing extends Message<TLPing> {
  ...
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: 'constructor', kind: 'enum', T: proto3.getEnumType(TLConstructor), opt: true },
    { no: 3, name: 'ping_id', kind: 'scalar', T: 3 /* ScalarType.INT64 */, opt: true },
  ])
  ...
  static equals(
    a: TLPing | PlainMessage<TLPing> | undefined,
    b: TLPing | PlainMessage<TLPing> | undefined
  ): boolean {
...
export class TLPingDelayDisconnect extends Message<TLPingDelayDisconnect> {
  ...
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: 'constructor', kind: 'enum', T: proto3.getEnumType(TLConstructor), opt: true },
    { no: 3, name: 'ping_id', kind: 'scalar', T: 3 /* ScalarType.INT64 */, opt: true },
    { no: 4, name: 'disconnect_delay', kind: 'scalar', T: 5 /* ScalarType.INT32 */, opt: true },
  ])
  ...
  static equals(
    a: TLPingDelayDisconnect | PlainMessage<TLPingDelayDisconnect> | undefined,
    b: TLPingDelayDisconnect | PlainMessage<TLPingDelayDisconnect> | undefined
  ): boolean {
...
export class TLDestroySession extends Message<TLDestroySession> {
  ...
  static equals(
    a: TLDestroySession | PlainMessage<TLDestroySession> | undefined,
    b: TLDestroySession | PlainMessage<TLDestroySession> | undefined
  ): boolean {
...
export class TLTestUseError extends Message<TLTestUseError> {
  ...
  static equals(
    a: TLTestUseError | PlainMessage<TLTestUseError> | undefined,
    b: TLTestUseError | PlainMessage<TLTestUseError> | undefined
  ): boolean {
...
export class TLTestUseConfigSimple extends Message<TLTestUseConfigSimple> {
  ...
  static equals(
    a: TLTestUseConfigSimple | PlainMessage<TLTestUseConfigSimple> | undefined,
    b: TLTestUseConfigSimple | PlainMessage<TLTestUseConfigSimple> | undefined
  ): boolean {
