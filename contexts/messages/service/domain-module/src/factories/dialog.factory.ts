...
export class DialogFactory {
  createDialog(createDialogDto: CreateDialogDto): Dialog {
    return new Dialog(
      ...
      false,
      createDialogDto.topMessage,
      0,
      0,
      createDialogDto.unreadCount,
      false,
      0,
      0
    )
  ...
  updateDialogInboxRead(dialog: Dialog, maxId: number, unreadCount: number): Dialog {
    return new Dialog(
      dialog.id,
      dialog.userId,
      dialog.peerType,
  ...
  updateDialogOutboxRead(dialog: Dialog, maxId: number): Dialog {
    return new Dialog(
      dialog.id,
      dialog.userId,
      dialog.peerType,
