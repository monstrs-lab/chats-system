...
import { Unique, Enum, Index }           from '@mikro-orm/core'

import { PeerType, MessageFilterType } from '@chats-system/messages-domain-module'

import { NativeBigIntType } from '../types/index.js'

@Entity({ tableName: 'messages' })
@Unique({ properties: ['userId', 'userMessageBoxId'] })
