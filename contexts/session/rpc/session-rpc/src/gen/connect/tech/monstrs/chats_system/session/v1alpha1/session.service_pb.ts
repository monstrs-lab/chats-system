...
export class SessionClientEvent extends Message<SessionClientEvent> {
  ...
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    ...
    { no: 5, name: "auth_key_id", kind: "scalar", T: 12 /* ScalarType.BYTES */, opt: true },
    { no: 6, name: "session_id", kind: "scalar", T: 12 /* ScalarType.BYTES */, opt: true },
...
export class SessionClientData extends Message<SessionClientData> {
  ...
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    ...
    { no: 9, name: "salt", kind: "scalar", T: 12 /* ScalarType.BYTES */, opt: true },
 ...
 */
export class SessionQueryAuthKeyResponse extends Message<SessionQueryAuthKeyResponse> {
  /**
   * @generated from field: optional tech.monstrs.chats_system.core.v1alpha1.AuthKeyInfo auth_key = 1;
   */
  authKey?: AuthKeyInfo;

  constructor(data?: PartialMessage<SessionQueryAuthKeyResponse>) {
    super();
    proto3.util.initPartial(data, this);
  }

  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "tech.monstrs.chats_system.session.v1alpha1.SessionQueryAuthKeyResponse";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "auth_key", kind: "message", T: AuthKeyInfo, opt: true },
  ]);

  static fromBinary(bytes: Uint8Array, options?: Partial<BinaryReadOptions>): SessionQueryAuthKeyResponse {
    return new SessionQueryAuthKeyResponse().fromBinary(bytes, options);
  }

  static fromJson(jsonValue: JsonValue, options?: Partial<JsonReadOptions>): SessionQueryAuthKeyResponse {
    return new SessionQueryAuthKeyResponse().fromJson(jsonValue, options);
  }

  static fromJsonString(jsonString: string, options?: Partial<JsonReadOptions>): SessionQueryAuthKeyResponse {
    return new SessionQueryAuthKeyResponse().fromJsonString(jsonString, options);
  }

  static equals(a: SessionQueryAuthKeyResponse | PlainMessage<SessionQueryAuthKeyResponse> | undefined, b: SessionQueryAuthKeyResponse | PlainMessage<SessionQueryAuthKeyResponse> | undefined): boolean {
    return proto3.util.equals(SessionQueryAuthKeyResponse, a, b);
  }
}
...
export class TLSessionPushSessionUpdatesData extends Message<TLSessionPushSessionUpdatesData> {
  ...
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "constructor", kind: "enum", T: proto3.getEnumType(TLConstructor), opt: true },
    { no: 3, name: "auth_key_id", kind: "scalar", T: 12 /* ScalarType.BYTES */, opt: true },
    { no: 4, name: "session_id", kind: "scalar", T: 12 /* ScalarType.BYTES */, opt: true },
    { no: 5, name: "updates", kind: "message", T: Updates, opt: true },
  ]);
...
export class TLSessionPushRpcResultData extends Message<TLSessionPushRpcResultData> {
  ...
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    ...
    { no: 3, name: "auth_key_id", kind: "scalar", T: 12 /* ScalarType.BYTES */, opt: true },
    { no: 4, name: "session_id", kind: "scalar", T: 12 /* ScalarType.BYTES */, opt: true },
    { no: 5, name: "client_req_msg_id", kind: "scalar", T: 12 /* ScalarType.BYTES */, opt: true },
