...
interface MessagesMessageReactionsListValues {
  flags: any
  count: number
  reactions: Array<any>
  chats: Array<any>
...
export class MessagesMessageReactionsList extends TLConstructor<MessagesMessageReactionsListValues> {
  static override CONSTRUCTOR_ID: number = 834488621
