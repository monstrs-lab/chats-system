...
interface ChatlistsChatlistInviteValues {
  flags: any
  title: string
  emoticon: string
  peers: Array<any>
...
export class ChatlistsChatlistInvite extends TLConstructor<ChatlistsChatlistInviteValues> {
  static override CONSTRUCTOR_ID: number = 500007837
