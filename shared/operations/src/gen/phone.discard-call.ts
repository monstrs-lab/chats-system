...
interface PhoneDiscardCallValues {
  flags: any
  video: boolean
  peer: any
  duration: number
...
export class PhoneDiscardCall extends TLMethod<PhoneDiscardCallValues> {
  static override CONSTRUCTOR_ID = -1295269440
  ...
  get connectionId(): bigint {
    return this.getParamValue<bigint>('connectionId')
  }
}
