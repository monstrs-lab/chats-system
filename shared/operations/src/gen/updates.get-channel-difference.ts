...
interface UpdatesGetChannelDifferenceValues {
  flags: any
  force: boolean
  channel: any
  filter: any
...
export class UpdatesGetChannelDifference extends TLMethod<UpdatesGetChannelDifferenceValues> {
  static override CONSTRUCTOR_ID = 51854712
