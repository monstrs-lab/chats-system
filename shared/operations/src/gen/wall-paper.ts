...
export class WallPaper extends TLConstructor<WallPaperValues> {
  static override CONSTRUCTOR_ID: number = -1539849235
  ...
  get pattern(): boolean {
    return this.getParamValue<boolean>('pattern')
  }
