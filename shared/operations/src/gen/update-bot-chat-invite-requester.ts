...
interface UpdateBotChatInviteRequesterValues {
  peer: any
  date: number
  userId: bigint
  about: string
...
export class UpdateBotChatInviteRequester extends TLConstructor<UpdateBotChatInviteRequesterValues> {
  static override CONSTRUCTOR_ID: number = 299870598
