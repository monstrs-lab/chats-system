...
interface PremiumGiftOptionValues {
  flags: any
  months: number
  currency: string
  amount: bigint
...
export class PremiumGiftOption extends TLConstructor<PremiumGiftOptionValues> {
  static override CONSTRUCTOR_ID: number = 1958953753
