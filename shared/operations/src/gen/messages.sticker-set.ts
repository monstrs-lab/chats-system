...
interface MessagesStickerSetValues {
  set: any
  packs: Array<any>
  keywords: Array<any>
  documents: Array<any>
...
export class MessagesStickerSet extends TLConstructor<MessagesStickerSetValues> {
  static override CONSTRUCTOR_ID: number = 1846886166
