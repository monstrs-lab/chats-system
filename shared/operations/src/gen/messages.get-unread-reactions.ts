...
interface MessagesGetUnreadReactionsValues {
  flags: any
  peer: any
  topMsgId: number
  offsetId: number
...
export class MessagesGetUnreadReactions extends TLMethod<MessagesGetUnreadReactionsValues> {
  static override CONSTRUCTOR_ID = 841173339
  ...
  get addOffset(): number {
    return this.getParamValue<number>('addOffset')
  }
