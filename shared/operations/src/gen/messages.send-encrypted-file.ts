...
interface MessagesSendEncryptedFileValues {
  flags: any
  silent: boolean
  peer: any
  randomId: bigint
...
export class MessagesSendEncryptedFile extends TLMethod<MessagesSendEncryptedFileValues> {
  static override CONSTRUCTOR_ID = 1431914525
