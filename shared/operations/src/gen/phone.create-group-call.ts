...
interface PhoneCreateGroupCallValues {
  flags: any
  rtmpStream: boolean
  peer: any
  randomId: number
...
export class PhoneCreateGroupCall extends TLMethod<PhoneCreateGroupCallValues> {
  static override CONSTRUCTOR_ID = 1221445336
