...
interface UpdateShortChatMessageValues {
  flags: any
  out: boolean
  mentioned: boolean
  mediaUnread: boolean
...
export class UpdateShortChatMessage extends TLConstructor<UpdateShortChatMessageValues> {
  static override CONSTRUCTOR_ID: number = 1299050149
  ...
  get fromId(): bigint {
    return this.getParamValue<bigint>('fromId')
  }
