...
export class HelpPremiumPromo extends TLConstructor<HelpPremiumPromoValues> {
  ...
  get statusText(): string {
    return this.getParamValue<string>('statusText')
  }

  get statusEntities(): Array<any> {
    return this.getParamValue<Array<any>>('statusEntities')
  }

  get videoSections(): Array<string> {
    return this.getParamValue<Array<string>>('videoSections')
  }

  get videos(): Array<any> {
    return this.getParamValue<Array<any>>('videos')
  }

  get periodOptions(): Array<any> {
    return this.getParamValue<Array<any>>('periodOptions')
  }
