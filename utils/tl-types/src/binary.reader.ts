...
import { readBigIntFromBuffer } from './convert.utils.js'
...
export class BinaryReader {
    ...
    #classMap: Record<number, TLObject>

    #last?: Buffer
    
    constructor(input: Buffer, classMap: Record<number, TLObject>) {
        this.#input = input
    ...
    readObject(): boolean | Array<TLObject> | TLObject  {
        ...
        let clazz = this.#classMap[constructorId];
