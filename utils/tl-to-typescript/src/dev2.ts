...
const tlToTypeScript = new TLToTypeScript({ outDir: './src/gen2' })

await tlToTypeScript.execute({
  constructors: [
    { id: '3162085175', predicate: 'boolFalse', params: [], type: 'Bool' },
    { id: '2574415285', predicate: 'boolTrue', params: [], type: 'Bool' },
    ...
    { id: '3112732367', predicate: 'inputUserEmpty', params: [], type: 'InputUser' },
    { id: '4156666175', predicate: 'inputUserSelf', params: [], type: 'InputUser' },
    {
      id: '4061223110',
      predicate: 'inputUser',
      params: [
    ...
    { id: '2523198847', predicate: 'inputMediaEmpty', params: [], type: 'InputMedia' },
    {
      id: '505969924',
    ...
    { id: '3837862870', predicate: 'inputGeoPointEmpty', params: [], type: 'InputGeoPoint' },
    {
      id: '1210199983',
    ...
    { id: '2861972229', predicate: 'storage.fileUnknown', params: [], type: 'storage.FileType' },
    ...
    { id: '3403786975', predicate: 'storage.fileGif', params: [], type: 'storage.FileType' },
    { id: '172975040', predicate: 'storage.filePng', params: [], type: 'storage.FileType' },
    { id: '2921222285', predicate: 'storage.filePdf', params: [], type: 'storage.FileType' },
    ...
    { id: '3016663268', predicate: 'storage.fileMp4', params: [], type: 'storage.FileType' },
    ...
    { id: '3798942449', predicate: 'userStatusRecently', params: [], type: 'UserStatus' },
    ...
    { id: '2676290718', predicate: 'messageMediaUnsupported', params: [], type: 'MessageMedia' },
    {
      id: '2628808919',
    ...
    { id: '3064919984', predicate: 'messageActionEmpty', params: [], type: 'MessageAction' },
    {
      id: '3175599021',
    ...
    { id: '2495428845', predicate: 'messageActionPinMessage', params: [], type: 'MessageAction' },
    { id: '2679813636', predicate: 'messageActionHistoryClear', params: [], type: 'MessageAction' },
    {
      id: '2460428406',
    ...
    { id: '2983951486', predicate: 'inputNotifyBroadcasts', params: [], type: 'InputNotifyPeer' },
    {
      id: '1548122514',
    ...
    { id: '3252986545', predicate: 'inputReportReasonOther', params: [], type: 'ReportReason' },
    { id: '2609510714', predicate: 'inputReportReasonCopyright', params: [], type: 'ReportReason' },
    {
      id: '3688169197',
    ...
    { id: '4124956391', predicate: 'inputReportReasonFake', params: [], type: 'ReportReason' },
    {
      id: '177124030',
    ...
    { id: '2680163941', predicate: 'inputMessagesFilterVideo', params: [], type: 'MessagesFilter' },
    {
      id: '1458172132',
    ...
    { id: '4291323271', predicate: 'inputMessagesFilterGif', params: [], type: 'MessagesFilter' },
    ...
    { id: '3875695885', predicate: 'inputMessagesFilterGeo', params: [], type: 'MessagesFilter' },
    {
      id: '3764575107',
    ...
    { id: '2473931806', predicate: 'updateSavedGifs', params: [], type: 'Update' },
    {
      id: '1232025500',
    ...
    { id: '2588027936', predicate: 'updateRecentStickers', params: [], type: 'Update' },
    { id: '2720652550', predicate: 'updateConfig', params: [], type: 'Update' },
    ...
    { id: '3843135853', predicate: 'updateFavedStickers', params: [], type: 'Update' },
    {
      id: '3928556893',
    ...
    { id: '397910539', predicate: 'updateAttachMenuBots', params: [], type: 'Update' },
    {
      id: '361936797',
    ...
    { id: '1960361625', predicate: 'updateSavedRingtones', params: [], type: 'Update' },
    {
      id: '8703322',
    ...
    { id: '4216080748', predicate: 'updateReadFeaturedEmojiStickers', params: [], type: 'Update' },
    {
      id: '674706841',
    ...
    { id: '821314523', predicate: 'updateRecentEmojiStatuses', params: [], type: 'Update' },
    { id: '1870160884', predicate: 'updateRecentReactions', params: [], type: 'Update' },
    {
      id: '2264715141',
    ...
    },
    {
      ...
      params: [
        { name: 'peer', type: 'Peer' },
        { name: 'msg_id', type: 'int' },
        { name: 'extended_media', type: 'MessageExtendedMedia' },
      ],
      type: 'Update',
    },
    {
    ...
    { id: '3959795863', predicate: 'updateAutoSaveSettings', params: [], type: 'Update' },
    {
      id: '2775329342',
    ...
    { id: '3809980286', predicate: 'updatesTooLong', params: [], type: 'Updates' },
    {
      id: '826001400',
    ...
    { id: '3294258486', predicate: 'help.noAppUpdate', params: [], type: 'help.AppUpdate' },
    {
      id: '415997816',
    ...
    { id: '3256830334', predicate: 'encryptedFileEmpty', params: [], type: 'EncryptedFile' },
    {
      id: '2818608344',
    ...
    { id: '3033021260', predicate: 'notifyUsers', params: [], type: 'NotifyPeer' },
    { id: '3221737155', predicate: 'notifyChats', params: [], type: 'NotifyPeer' },
    { id: '3591563503', predicate: 'notifyBroadcasts', params: [], type: 'NotifyPeer' },
    {
      id: '577659656',
    ...
    { id: '3684593874', predicate: 'inputPrivacyKeyPhoneP2P', params: [], type: 'InputPrivacyKey' },
    { id: '2765966344', predicate: 'inputPrivacyKeyForwards', params: [], type: 'InputPrivacyKey' },
    {
      id: '1461304012',
    ...
    { id: '3157175088', predicate: 'privacyKeyStatusTimestamp', params: [], type: 'PrivacyKey' },
    ...
    { id: '2517966829', predicate: 'privacyKeyProfilePhoto', params: [], type: 'PrivacyKey' },
    { id: '3516589165', predicate: 'privacyKeyPhoneNumber', params: [], type: 'PrivacyKey' },
    { id: '1124062251', predicate: 'privacyKeyAddedByPhone', params: [], type: 'PrivacyKey' },
    { id: '110621716', predicate: 'privacyKeyVoiceMessages', params: [], type: 'PrivacyKey' },
    {
      id: '218751099',
    ...
    { id: '4294843308', predicate: 'privacyValueAllowContacts', params: [], type: 'PrivacyRule' },
    ...
    { id: '2339628899', predicate: 'privacyValueDisallowAll', params: [], type: 'PrivacyRule' },
    {
      id: '3831632193',
    ...
    { id: '4290128789', predicate: 'inputStickerSetEmpty', params: [], type: 'InputStickerSet' },
    {
      id: '2649203305',
    ...
    { id: '4002160262', predicate: 'inputChannelEmpty', params: [], type: 'InputChannel' },
    {
      id: '4082822184',
    ...
    { id: '3592083182', predicate: 'auth.codeTypeMissedCall', params: [], type: 'auth.CodeType' },
    { id: '116234636', predicate: 'auth.codeTypeFragmentSms', params: [], type: 'auth.CodeType' },
    {
      id: '1035688326',
    ...
    { id: '2875595611', predicate: 'topPeerCategoryBotsPM', params: [], type: 'TopPeerCategory' },
    {
      id: '344356834',
    ...
    { id: '3172442442', predicate: 'topPeerCategoryGroups', params: [], type: 'TopPeerCategory' },
    ...
    { id: '3695018575', predicate: 'textEmpty', params: [], type: 'RichText' },
    {
      id: '1950782688',
      predicate: 'textPlain',
      params: [{ name: 'text', type: 'string' }],
    ...
    { id: '3676352904', predicate: 'pageBlockDivider', params: [], type: 'PageBlock' },
    {
      id: '3456972720',
    ...
    { id: '2257003832', predicate: 'inputMessagePinned', params: [], type: 'InputMessage' },
    {
      id: '2902071934',
    ...
    { id: '3420659238', predicate: 'secureValueTypeAddress', params: [], type: 'SecureValueType' },
    {
      id: '4231435598',
    ...
    { id: '3005262555', predicate: 'secureValueTypePhone', params: [], type: 'SecureValueType' },
    { id: '2386339822', predicate: 'secureValueTypeEmail', params: [], type: 'SecureValueType' },
    {
      id: '411017418',
    ...
    { id: '3562713238', predicate: 'passwordKdfAlgoUnknown', params: [], type: 'PasswordKdfAlgo' },
    {
      id: '982592842',
    ...
    { id: '4088278765', predicate: 'help.userInfoEmpty', params: [], type: 'help.UserInfo' },
    {
      id: '32192344',
    ...
    { id: '2849430303', predicate: 'urlAuthResultDefault', params: [], type: 'UrlAuthResult' },
    { id: '3216354699', predicate: 'channelLocationEmpty', params: [], type: 'ChannelLocation' },
    {
      id: '547062491',
    ...
    { id: '3282117730', predicate: 'baseThemeClassic', params: [], type: 'BaseTheme' },
    { id: '4225242760', predicate: 'baseThemeDay', params: [], type: 'BaseTheme' },
    { id: '3081969320', predicate: 'baseThemeNight', params: [], type: 'BaseTheme' },
    { id: '1834973166', predicate: 'baseThemeTinted', params: [], type: 'BaseTheme' },
    ...
    { id: '909284270', predicate: 'dialogFilterDefault', params: [], type: 'DialogFilter' },
    {
      id: '2004110666',
    ...
    { id: '1011811544', predicate: 'botCommandScopeUsers', params: [], type: 'BotCommandScope' },
    ...
    },
    {
      ...
      params: [
        ...
        { name: 'show_peer_photo', type: 'flags.6?true' },
    ...
    { id: '1966318984', predicate: 'botMenuButtonDefault', params: [], type: 'BotMenuButton' },
    { id: '1113113093', predicate: 'botMenuButtonCommands', params: [], type: 'BotMenuButton' },
    {
      id: '3350559974',
    ...
    { id: '1863070943', predicate: 'notificationSoundNone', params: [], type: 'NotificationSound' },
    {
      id: '2198575844',
    ...
    { id: '4047950623', predicate: 'attachMenuPeerTypePM', params: [], type: 'AttachMenuPeerType' },
    { id: '84480319', predicate: 'attachMenuPeerTypeChat', params: [], type: 'AttachMenuPeerType' },
    {
      id: '2080104188',
    ...
    { id: '769727150', predicate: 'emojiStatusEmpty', params: [], type: 'EmojiStatus' },
    {
      id: '2459656605',
    ...
    { id: '2046153753', predicate: 'reactionEmpty', params: [], type: 'Reaction' },
    {
      id: '455247544',
    ...
    { id: '3942396604', predicate: 'chatReactionsNone', params: [], type: 'ChatReactions' },
    {
      id: '1385335754',
    ...
    { id: '1209970170', predicate: 'emojiListNotModified', params: [], type: 'EmojiList' },
    {
      id: '2048790993',
      predicate: 'emojiList',
      params: [
  ...
  methods: [
    ...
    { id: '2678787354', method: 'auth.resetAuthorizations', params: [], type: 'Bool' },
    {
      id: '3854565325',
    ...
    { id: '2668087080', method: 'account.getContactSignUpNotification', params: [], type: 'Bool' },
    {
      id: '3488890721',
    ...
    },
    {
      ...
      params: [
        ...
        { name: 'no_webpage', type: 'flags.1?true' },
        { name: 'reply_to_msg_id', type: 'flags.0?int' },
        { name: 'top_msg_id', type: 'flags.2?int' },
        { name: 'peer', type: 'InputPeer' },
        { name: 'message', type: 'string' },
        { name: 'entities', type: 'flags.3?Vector<MessageEntity>' },
      ],
    ...
    { id: '3990128682', method: 'updates.getState', params: [], type: 'updates.State' },
    {
      id: '630429265',
    ...
    { id: '2631862477', method: 'help.getSupport', params: [], type: 'help.Support' },
    {
      id: '4000511898',
    ...
    { id: '2559656208', method: 'help.getAppConfig', params: [], type: 'JSONValue' },
    {
      id: '1935116200',
    ...
    { id: '3088815060', method: 'help.getPremiumPromo', params: [], type: 'help.PremiumPromo' },
    {
      id: '3423619383',
