...
export class BindAuthKeyInner extends TLConstructor {
    ...
    constructor(public readonly nonce: bigint, public readonly tempAuthKeyId: bigint, public readonly permAuthKeyId: bigint, public readonly tempSessionId: bigint, public readonly expiresAt: number) {
        super()
    }
}
