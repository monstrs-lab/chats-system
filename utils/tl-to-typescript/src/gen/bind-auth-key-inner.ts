...
export class BindAuthKeyInner extends TLConstructor {
    ...
    constructor(public readonly nonce: bigint, public readonly temp_auth_key_id: bigint, public readonly perm_auth_key_id: bigint, public readonly temp_session_id: bigint, public readonly expires_at: number) {
        super()
    }
}
