...
export class ServerDHInnerData extends TLConstructor {
    ...
    constructor(public readonly nonce: bigint, public readonly serverNonce: bigint, public readonly g: number, public readonly dhPrime: Buffer, public readonly gA: Buffer, public readonly serverTime: number) {
        super()
    }
}
