...
export class ServerDHInnerData extends TLConstructor {
    ...
    constructor(public readonly nonce: bigint, public readonly server_nonce: bigint, public readonly g: number, public readonly dh_prime: Buffer, public readonly g_a: Buffer, public readonly server_time: number) {
        super()
    }
}
