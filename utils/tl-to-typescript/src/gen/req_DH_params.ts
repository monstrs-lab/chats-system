...
export class ReqDHParams extends TLMethod {
    ...
    constructor(public readonly nonce: any, public readonly server_nonce: any, public readonly p: any, public readonly q: any, public readonly public_key_fingerprint: any, public readonly encrypted_data: any) {
        super()
    }
}
