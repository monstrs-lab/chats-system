...
export class BadServerSalt extends TLConstructor {
    ...
    constructor(public readonly bad_msg_id: bigint, public readonly bad_msg_seqno: number, public readonly error_code: number, public readonly new_server_salt: bigint) {
        super()
    }
}
