...
export class ResPQ extends TLConstructor {
    ...
    constructor(public readonly nonce: bigint, public readonly server_nonce: bigint, public readonly pq: Buffer, public readonly server_public_key_fingerprints: Array<bigint>) {
        super()
    }
}
