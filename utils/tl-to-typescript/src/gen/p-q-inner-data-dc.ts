...
export class PQInnerDataDc extends TLConstructor {
    ...
    constructor(public readonly pq: Buffer, public readonly p: Buffer, public readonly q: Buffer, public readonly nonce: bigint, public readonly serverNonce: bigint, public readonly newNonce: bigint, public readonly dc: number) {
        super()
    }
}
