...
export class PQInnerDataTempDc extends TLConstructor {
    ...
    constructor(public readonly pq: Buffer, public readonly p: Buffer, public readonly q: Buffer, public readonly nonce: bigint, public readonly server_nonce: bigint, public readonly new_nonce: bigint, public readonly dc: number, public readonly expires_in: number) {
        super()
    }
}
