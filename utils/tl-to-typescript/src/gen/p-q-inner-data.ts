...
export class PQInnerData extends TLConstructor {
    ...
    constructor(public readonly pq: string, public readonly p: string, public readonly q: string, public readonly nonce: bigint, public readonly serverNonce: bigint, public readonly newNonce: bigint) {
        super()
    }
}
