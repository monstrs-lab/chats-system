...
export class ReqDHParams extends TLMethod {
    ...
    constructor(public readonly nonce: bigint, public readonly serverNonce: bigint, public readonly p: Buffer, public readonly q: Buffer, public readonly publicKeyFingerprint: bigint, public readonly encryptedData: Buffer) {
        super()
    }
}
