...
export class ReqDHParams extends TLMethod {
    ...
    constructor(public readonly nonce: bigint, public readonly server_nonce: bigint, public readonly p: Buffer, public readonly q: Buffer, public readonly public_key_fingerprint: bigint, public readonly encrypted_data: Buffer) {
        super()
    }
}
