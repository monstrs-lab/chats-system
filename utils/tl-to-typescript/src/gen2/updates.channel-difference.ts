...
interface UpdatesChannelDifferenceValues {
    flags: any;
    final: boolean;
    pts: number;
    timeout: number;
...
export class UpdatesChannelDifference extends TLConstructor<UpdatesChannelDifferenceValues> {
    static override CONSTRUCTOR_ID: number = 543450958;
