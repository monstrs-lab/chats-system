...
interface InputBotInlineMessageMediaGeoValues {
    flags: any;
    geoPoint: any;
    heading: number;
    period: number;
...
export class InputBotInlineMessageMediaGeo extends TLConstructor<InputBotInlineMessageMediaGeoValues> {
    static override CONSTRUCTOR_ID: number = 2526190213;
