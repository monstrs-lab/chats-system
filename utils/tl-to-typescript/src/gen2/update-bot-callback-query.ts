...
interface UpdateBotCallbackQueryValues {
    flags: any;
    queryId: bigint;
    userId: bigint;
    peer: any;
...
export class UpdateBotCallbackQuery extends TLConstructor<UpdateBotCallbackQueryValues> {
    static override CONSTRUCTOR_ID: number = 3117401229;
