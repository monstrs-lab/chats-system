...
export class PageTableCell extends TLConstructor<PageTableCellValues> {
    ...
    get alignCenter(): boolean {
        return this.values.alignCenter
    }

    get alignRight(): boolean {
        return this.values.alignRight
    }

    get valignMiddle(): boolean {
        return this.values.valignMiddle
    }

    get valignBottom(): boolean {
        return this.values.valignBottom
    }
    ...
    get colspan(): number {
        return this.values.colspan
    }

    get rowspan(): number {
        return this.values.rowspan
    }
}
