...
export class Authorization extends TLConstructor<AuthorizationValues> {
    static override CONSTRUCTOR_ID: number = 2902578717;
    ...
    get officialApp(): boolean {
        return this.values.officialApp
    }

    get passwordPending(): boolean {
        return this.values.passwordPending
    }
    ...
    get dateCreated(): number {
        return this.values.dateCreated
    }

    get dateActive(): number {
        return this.values.dateActive
    }
