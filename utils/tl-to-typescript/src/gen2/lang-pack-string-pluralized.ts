...
export class LangPackStringPluralized extends TLConstructor<LangPackStringPluralizedValues> {
    ...
    get zeroValue(): string {
        return this.values.zeroValue
    }

    get oneValue(): string {
        return this.values.oneValue
    }

    get twoValue(): string {
        return this.values.twoValue
    }

    get fewValue(): string {
        return this.values.fewValue
    }

    get manyValue(): string {
        return this.values.manyValue
    }

    get otherValue(): string {
        return this.values.otherValue
    }
}
