...
interface MessagesGetUnreadMentionsValues {
    flags: any;
    peer: any;
    topMsgId: number;
    offsetId: number;
...
export class MessagesGetUnreadMentions extends TLMethod<MessagesGetUnreadMentionsValues> {
    static override CONSTRUCTOR_ID = 4043827088;
